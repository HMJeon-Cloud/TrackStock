...
var GUIDE_METHODS = [
  ...
  },
  {
    ...
    steps: [
      { t: "차트에 이동평균선을 켜고 최근 종가와 240일선 위치를 봅니다", d: "20일(파랑)·60일(초록)·240일(보라). 주가 > 20일선 > 60일선 > 240일선 순으로 위에서 아래로 놓이면(정배열) 강한 상승 추세, 그 반대(역배열)면 하락 추세입니다.", go: { tab: "single", sub: "analysis", id: "chartCard" }, label: "메인 차트 (이동평균선 체크)" },
